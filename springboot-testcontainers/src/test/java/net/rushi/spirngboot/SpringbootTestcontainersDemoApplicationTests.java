package net.rushi.spirngboot;

import net.rushi.spirngboot.entity.Student;
import net.rushi.spirngboot.repository.StudentRepository;
...
class SpringbootTestcontainersDemoApplicationTests extends AbstractContainerBaseTest{
	...
	public void givenStudents_whenGetAllStudents_thenListOfStudents() throws Exception {
		...
		List<Student> students =
				List.of(Student.builder().firstName("Rushikesh").lastName("Bawkar").email("rkbawkar@mitaoe.ac.in").build(),
